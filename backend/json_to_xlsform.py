...
def convert_json_to_xlsform(parsed_json: dict) -> bytes:
    ...
    return _build_excel(survey_rows, choices_rows, settings)
...
def convert_docx_to_xlsform(docx_path: str) -> bytes:
...
def convert_parsed_json_to_xlsform(json_path: str) -> bytes:
...
if __name__ == "__main__":
    ...
    xlsx = convert_parsed_json_to_xlsform(src) if src.endswith(".json") \
